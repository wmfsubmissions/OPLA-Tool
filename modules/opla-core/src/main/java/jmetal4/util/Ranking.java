...
import jmetal4.util.comparators.OverallConstraintViolationComparator;
...
public class Ranking {
    ...
    public Ranking(SolutionSet solutionSet) {
        ...
        // dominateMe[solution] contains the number of solutions dominating solution
        int[] dominateMe = new int[solutionSet_.size()];

        // iDominate[k] contains the list of solutions dominated by k
        // iDominate[solution] contains the list of solutions dominated by solution
        List<Integer>[] iDominate = new List[solutionSet_.size()];

        // front[i] contains the list of individuals belonging to the front i
        // quanto menor i, melhor a solução. se i == 0, domina todas as soluções. se i ==1, domina todas as soluções exceto o front[0] e assim por diante. quanto menor o front, pior é
